...
public abstract class f<K, V> {
    ...
    final class a<T> implements Iterator<T> {
        ...
        public T next() {
            ...
            T t = (T) f.this.b(this.g, this.f693e);
            this.g++;
            this.h = true;
            return t;
        }
    ...
    final class b implements Set<Map.Entry<K, V>> {
        ...
        public boolean contains(Object obj) {
            ...
            return c.d.c.c(f.this.b(e2, 1), entry.getValue());
        }
    ...
    final class d implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public boolean equals(Object obj) {
            ...
            Map.Entry entry = (Map.Entry) obj;
            return c.d.c.c(entry.getKey(), f.this.b(this.f, 0)) && c.d.c.c(entry.getValue(), f.this.b(this.f, 1));
        }

        @Override // java.util.Map.Entry
        public K getKey() {
            if (this.g) {
                return (K) f.this.b(this.f, 0);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
        ...
        public int hashCode() {
            ...
            Object b2 = f.this.b(this.f, 0);
            Object b3 = f.this.b(this.f, 1);
