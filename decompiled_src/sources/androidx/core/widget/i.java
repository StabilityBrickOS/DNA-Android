...
public final class i {
    ...
    private static class a implements ActionMode.Callback {
        ...
        private final TextView f356b;

        /* renamed from: c, reason: collision with root package name */
        private Class<?> f357c;

        /* renamed from: d, reason: collision with root package name */
        private Method f358d;
        ...
        private void f(Menu menu) {
            ...
            if (!this.f) {
                ...
                try {
                    ...
                    this.f357c = cls;
                    this.f358d = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                    this.f359e = true;
            ...
            try {
                Method declaredMethod = (this.f359e && this.f357c.isInstance(menu)) ? this.f358d : menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE);
                ...
                for (int i = 0; i < c2.size(); i++) {
                    ...
                    menu.add(0, 0, i + 100, resolveInfo.loadLabel(packageManager)).setIntent(b(resolveInfo, this.f356b)).setShowAsAction(1);
                }
    ...
    public static c.a f(TextView textView) {
        ...
        c.a.C0033a c0033a = new c.a.C0033a(new TextPaint(textView.getPaint()));
        if (Build.VERSION.SDK_INT >= 23) {
            c0033a.b(textView.getBreakStrategy());
            c0033a.c(textView.getHyphenationFrequency());
        }
    ...
    public static void m(TextView textView, c.f.j.c cVar) {
