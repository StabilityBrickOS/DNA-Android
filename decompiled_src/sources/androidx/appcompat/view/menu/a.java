...
public class a implements c.f.f.a.b {
    private final int a;
    ...
    public a(Context context, int i, int i2, int i3, int i4, CharSequence charSequence) {
        ...
        this.f106b = i;
        this.f107c = i4;
        this.f108d = charSequence;
    }

    private void c() {
        if (this.k != null) {
            if (this.q || this.r) {
                Drawable r = androidx.core.graphics.drawable.a.r(this.k);
                this.k = r;
    ...
    public c.f.f.a.b d(int i) {
        throw new UnsupportedOperationException();
    }

    public c.f.f.a.b e(View view) {
        throw new UnsupportedOperationException();
    }
    ...
    public CharSequence getTitleCondensed() {
        ...
        return charSequence != null ? charSequence : this.f108d;
    }
    ...
    public MenuItem setTitle(int i) {
        this.f108d = this.l.getResources().getString(i);
        return this;
    }
