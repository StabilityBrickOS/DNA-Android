...
public final class FloatMonitorChartView extends View {
    ...
    public static final class a implements ValueAnimator.AnimatorUpdateListener {
        ...
        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            FloatMonitorChartView floatMonitorChartView = FloatMonitorChartView.this;
            i.c(valueAnimator, "animation");
            Object animatedValue = valueAnimator.getAnimatedValue();
            if (animatedValue == null) {
                throw new NullPointerException("null cannot be cast to non-null type kotlin.Int");
            }
            floatMonitorChartView.f = ((Integer) animatedValue).intValue();
            FloatMonitorChartView.this.invalidate();
        }
    }
    ...
    public FloatMonitorChartView(Context context, AttributeSet attributeSet) {
        ...
        this.f1017e = 100 - ((int) ((obtainStyledAttributes.getInteger(0, 1) * 100.0d) / obtainStyledAttributes.getInteger(1, 1)));
    ...
    public final void f(float f, float f2) {
        this.f1017e = (f2 == f && f == 0.0f) ? 0 : 100 - ((int) ((f2 * 100.0d) / f));
        b(this.f1017e);
    }
