...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final c.d.a<String, Integer> g;
    ...
    static {
        ...
        g.put("android.media.metadata.BT_FOLDER_TYPE", 0);
        g.put("android.media.metadata.MEDIA_URI", 1);
        g.put("android.media.metadata.ADVERTISEMENT", 0);
        g.put("android.media.metadata.DOWNLOAD_STATUS", 0);
        CREATOR = new a();
    }

    MediaMetadataCompat(Parcel parcel) {
        this.f14e = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }

    public static MediaMetadataCompat f(Object obj) {
